...
static Color colorScheme;
  ...
  {
    int R = rand.nextInt(GLOBAL_R);
    int G = rand.nextInt(GLOBAL_G);
    int B = rand.nextInt(GLOBAL_B);
...
/*  public void global_seed()
{
    

GLOBAL_R = Random.nextInt(256);
GLOBAL_G = Random.nextInt(256);
GLOBAL_B = Random.nextInt(256);
...
//add a way to pre determine the color scheme